...
namespace XF.Common
{
    ...
    public static class EventsBroker
    {
        ...
        public static void FireInParallel<T, U, V, W, X, Y>(GenericEventHandler<T, U, V, W, X, Y> del, T t, U u, V v, W w, X x, Y y)
        {
            UnsafeFireInParallel(del, t, u, v, w, x, y);
        }

        public static void FireInParallel<T, U, V, W, X, Y, Z>(GenericEventHandler<T, U, V, W, X, Y, Z> del, T t, U u, V v, W w, X x, Y y, Z z)
        {
